<!-- Start Page::View(main-mainpanel) -->
            ...
            <tr>
              ...
              <td class="text_login_h2_grey" height="45">Search:
                ...
                &nbsp;<img alt="" src="/managedNOC/admin/images/btn_search.gif" align="absmiddle" height="18" width="52"></img> <span class="text_login_h3_RED">Advanced Search! </span></td>
            </tr>

            <tr>
              <td><table border="0" cellpadding="0" cellspacing="0" width="747">
                <tr>
                  <td class="text_login_h" background="images/customer-login_heading_bg6.gif" height="36"><img alt="" src="/managedNOC/admin/images/spacer.gif" height="2" width="10"></img>Ticket Search (1)</td>
                </tr>
                <tr>
