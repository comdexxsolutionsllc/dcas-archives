          ...
          <tr>
            <td width="50%" height="58"><table width="300" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="70" align="center"><a href="http://mydediserver.com/#redirect__panel"><img alt="" src="<?php echo $coreEngine->sRU; ?>admin/images/btn_support.gif" width="53" height="30" border="0" /></a></td>
      ...
      <table width="763" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="910" align="left" valign="top" background="images/line_21.gif" class="bg_fixed_repeat_y"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="35" class="text_login_h_green">Welcome to the Employee Managment Portal </td>
            </tr>
		...
		<tr>
          <td height="43" valign="bottom" background="images/line_2btDFDF.gif" class="bg_fixed_repeat_y"><table width="400" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
