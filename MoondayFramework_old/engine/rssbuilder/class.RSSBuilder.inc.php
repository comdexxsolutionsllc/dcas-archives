...
* @version 1.001
*/
class RSSBuilder extends RSSBaseObject {
	...
	*/
	function outputRSS($version = '') {
		...
		$this->output = '<?phpxml version="1.0" encoding="' . $this->encoding . '"?>' . "\n" .
	...
	*/
	function getRSSOutput($version = '') {
		...
		return (string) '<?phpxml version="1.0" encoding="' . $this->encoding . '"?>' . "\n" .
						'<!--  RSS generated by Flaimo.com RSS Builder [' .  date('Y-m-d H:i:s')  .']  --> ' . $this->output;
	} // end function
...
* @version 1.001
*/
class RSSItem extends RSSBaseObject {
