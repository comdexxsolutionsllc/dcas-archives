...
<?php //$coreException = new coreException('message', 'code', '', '', ''); echo $coreException->__toString(); ?>
...
// + Added "Object" to className
class LinkedExceptionObject extends Exception {
    private $cause;
...
<?php //$LinkedException = new LinkedException('message', 'code', null); ?>