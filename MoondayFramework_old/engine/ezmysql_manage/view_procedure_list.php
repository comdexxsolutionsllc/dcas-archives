...
to delete the procedure [ <span class="TitleText12"><?= $_REQUEST['SPName']; ?></span> ] <br />
<br />
...
}else
{
	...
	<table width="95%" border="0" cellspacing="5" class="ContText12">
	  ...
	  <tr>
		<td align="center" valign="top"><? echo $ezMySQL->ProcedureList("update_sp.php","view_procedure_list.php"); ?></td>
	  </tr>
	</table>
	<?
		}else
	...
	?>
	<br /><br /><br />
	<div align="center" class="ContText12"><?= "<span class='TitleText12'>Message: </span>".$StrMsg; ?></div>
<?
	}
}
?>
