              ...
              <td colspan="3" align="center" valign="top"><form id="form1" name="form1" method="post" action="">
                <table width="100%" border="0" cellspacing="5" class="ContText12">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><input name="txtdb" type="text" class="ContText14" id="txtdb" value="<?= $_POST['txtdb']; ?>" size="50" /></td>
                  </tr>
                  
                  <tr>
                    <td width="18%" align="right" valign="top">Code:</td>
                    <td width="82%" align="left" valign="top"><textarea name="txtSP" cols="80" rows="15" class="ContText14" id="txtSP"><?= $_POST['txtSP']; ?></textarea>
                      <br />
                        <br />
