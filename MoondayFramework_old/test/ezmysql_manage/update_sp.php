              ...
              <td colspan="2" align="center" valign="top"><form id="form1" name="form1" method="post" action="update_sp.php">
                <table width="100%" border="0" cellspacing="5" class="ContText12">
                  ...
                  <tr>
                    ...
                    <td width="81%" align="left" valign="top"><textarea name="txtSP" cols="80" rows="20" class="ContText12" id="txtSP"><?php $SPBody; ?></textarea>
                    <br />
                        <br />
...
<input name="hdnSPName" type="hidden" id="hdnSPName" value="<?php echo $_REQUEST['SPName']; ?>" />
<input name="hdndbName" type="hidden" id="hdndbName" value="<?php echo $_REQUEST['dbName']; ?>" />
<textarea style="display:none" name="hdnSPOrigin" id="hdnSPOrigin" rows="5" cols="50"><?php if(!$_POST['hdnSPOrigin']) echo $SPBody; else echo $ezMySQL->FormatText($_POST['hdnSPOrigin']); ?></textarea></td>
                  </tr>
                </table>
                            </form>              </td>
              </tr>
